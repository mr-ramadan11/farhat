...
Object.keys(primary).forEach(grade => {
  ...
  const unit3 = primary[grade]["الوحدة الثالثة"];

  // حذف القديم
  delete unit3["القواعد الإملائية"];
  delete unit3["التعبير الكتابي"];
  delete unit3["تطبيق على القواعد الإملائية"];
  delete unit3["تطبيق على التعبير الكتابي"];

  // إضافة الجديد
  unit3["تطبيق على القواعد الإملائية"] = {};
  unit3["تطبيق على التعبير الكتابي"] = {};
  unit3["تطبيق على القواعد الإملائية 2"] = {};
  unit3["تطبيق على التعبير الكتابي 2"] = {};
});
...
Object.keys(prep).forEach(grade => {
  ...
  const unit3 = prep[grade]["الوحدة الثالثة"];
